...
import CareerFitV2 from "./CareetFitV2";
import { extractInterviewAssessment, formatDateToRelativeTime } from "../../../Utils";

export default function CandidateCardV2({ candidate, stage, handleCandidateMenuOpen, handleCandidateCVOpen, handleEndorseCandidate, handleDropCandidate, handleCandidateHistoryOpen, handleRetakeInterview}: any) {
    ...
    return (
        ...
        onClick={(e) => {
            ...
            <div className="candidate-card-section" style={{ justifyContent: "space-between" }}>
                <CareerFitV2 fit={currentStep === "CV Screening" || stage === "Pending AI Interview" ? `CV: ${cvStatus || "N/A"}` : `Interview: ${jobFit || "N/A"}`} assessment={currentStep === "CV Screening" || stage === "Pending AI Interview" ? cvScreeningReason : extractInterviewAssessment(summary)} />
