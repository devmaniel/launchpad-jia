...
interface FinalHumanInterviewCardProps {
  // Add any props if needed
}

const FinalHumanInterviewCard: React.FC<FinalHumanInterviewCardProps> = () => {
  return (
    <div
      style={{
        width: "100%",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          {["Waiting for Schedule", "Waiting for Interview", "For Review"].map((stage) => (
            <div
              key={stage}
              style={{
                display: "flex",
...
export default FinalHumanInterviewCard;