      ...
      {isOpen && (
        <div id="career-details-content" style={{ marginTop: 16 }}>
          ...
          >
            ...
            <div>
              <p style={{ marginBottom: 12, fontSize: 14, fontWeight: 600, color: "#181D27" }}>Team Access</p>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {teamAccess.map((member, idx) => (
                  <div
                    key={idx}
                    style={{
                      display: "flex",
...
export default CareerDetailsTeamAccess;
