...
export default function TipsContainer({ items }: { items?: { title: string; text: string }[] }) {
  return (
    <div style={{ width: 320, minWidth: 320, maxWidth: 320, flex: "0 0 320px", position: "sticky", top: 20 }}>
